...
public class Multilevelinheritance extends Singleinheritance{
    ...
    Multilevelinheritance(int id, float salary, String program) {
        super(id, salary,program);
        System.out.println(super.salary);
    }
    ...
    public static void main(String[] args) {
        ...
        obj.print();
        Multilevelinheritance obj2 = new Multilevelinheritance(1001, 120000, "python");
        obj2.print();
